...
ActiveRecord::Schema.define(version: 2022_09_14_214650) do
  ...
  create_table "meal_joins", force: :cascade do |t|
    ...
    t.datetime "created_at", precision: 6, null: false
    t.datetime "updated_at", precision: 6, null: false
    t.index ["food_id"], name: "index_meal_joins_on_food_id"
    t.index ["meal_category_id"], name: "index_meal_joins_on_meal_category_id"
  end
  ...
  add_foreign_key "meal_joins", "foods"
  add_foreign_key "meal_joins", "meal_categories"
end
